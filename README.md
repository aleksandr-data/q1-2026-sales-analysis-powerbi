...
Ниже приведены ключевые меры в наглядном виде, отражающем логику расчётов, использованных в проекте.
...
Этот проект был первым и намеренно простым. 
В следующих проектах я уже усложнил стек и работу с данными: 
использовал **PostgreSQL**, более серьёзную проверку качества данных и **Python/pandas**.
